...
extern "C"
{
	...
	{
		return (void *) IW::Alloc(sizeofobject);
	}
	...
	*/
	...
	{
		return (void FAR *) IW::Alloc(sizeofobject);
	}
...
#ifndef DEFAULT_nMax_MEM		/* so can override from makefile */
#define DEFAULT_nMax_MEM		200 * 1025 * 1024L /* default: 200 megabyte */
#endif
	...
	*/
	...
	{
		return INT_MAX;	/* default for max_memory_to_use */
	}
